    ...
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 animate-fade-in">
      <div className="bg-white/80 backdrop-blur-xl border border-blue-200/50 rounded-2xl w-full max-w-md shadow-2xl text-blue-900 max-h-[90vh] flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 overflow-y-auto">
          <div>
            <label htmlFor="cat-title" className="block text-sm font-medium text-blue-800">{t('categoryTitle')}</label>
           ...
           <div>
            <label className="block text-sm font-medium text-blue-800">{t('categoryIllustration')}</label>
            <div className="mt-1">
                {illustrationUrl ? (
